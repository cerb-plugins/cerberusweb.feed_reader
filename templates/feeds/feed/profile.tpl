...
<fieldset class="properties">
	...
	<form class="toolbar" action="{devblocks_url}{/devblocks_url}" method="post" style="margin-bottom:5px;">
		...
		<!-- Edit -->
		<button type="button" id="btnDisplayFeedEdit" title="{'common.edit'|devblocks_translate|capitalize}">&nbsp;<span class="cerb-sprite2 sprite-gear"></span>&nbsp;</button>
	</form>
...
<script type="text/javascript">
	$(function() {
		var tabs = $("#feedTabs").tabs( { selected:{$selected_tab_idx} } );
